...
const Header = () => {
  return (
    <header className='border-b border-siteBlack fixed top-0 left-0 w-full z-[11] bg-siteWhite/80 backdrop-blur-sm'>
        <div className='container py-3 flex justify-center md:justify-between items-center flex-wrap'>
          <div className=''>
          ...
          <div className='flex gap-4'>
            ...
            <a className='hover:text-primary flex gap-2 items-center' href='tel:+919788453539'>
